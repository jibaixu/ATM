...
BASE_DIR = Path("/home/jibaixu/Datasets/Cobot_Magic_all_extracted/tmp")
VAL_JSONL = BASE_DIR / "episodes_new_81_train.jsonl"
SAVE_DIR = "results/vis_dataset"
...
def main():
    ...
    viz.visualize(
        ...
        filename=f"ep_{item['episode_index']}_{Path(item['video']).stem}"
    )
